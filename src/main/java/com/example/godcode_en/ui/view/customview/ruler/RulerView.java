package com.example.godcode_en.ui.view.customview.ruler;
...
public class RulerView extends View implements ScrollChange {
    ...
    private void init(Context context) {
        ...
        mTextPaint.setTextSize(pt2px(42));
        mTextPaint.setColor(Color.parseColor("#8f92a1"));
        mTextPaint.setTextAlign(Paint.Align.CENTER);


        heighLightPaint = new Paint();
        heighLightPaint.setAntiAlias(true);
        heighLightPaint.setTextSize(pt2px(77));
        heighLightPaint.setColor(Color.WHITE);
        heighLightPaint.setTextAlign(Paint.Align.CENTER);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                System.out.println(TAG + mMinVelocity + "===========velocity==============" + xVelocity);
